...
if (isset($_GET['success'])){
	$registeredUser = $_GET['success'];
}
if(isset($_GET['fail'])){
	$UnregisteredUser = $_GET['fail'];
			...
			<div class="row">
				<div class="col-lg-6 col-md-6 col-sm-6">
					<div class="student-count">
						<p><span>Total Students: <?php $totalstu = $registeredUser +$UnregisteredUser ; echo $totalstu ?> </span>  </p>
						<p><span>Registered Students: </span>  <?php echo $registeredUser?></p>
						<p><span>Unregister Students: </span>  <?php echo $UnregisteredUser?></p>
					</div>
				</div>
				<div class="col-lg-6 col-md-6 col-sm-6">
					<form>
